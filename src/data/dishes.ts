...
export const dishes: Recipe[] = [
    ...
    },
    {
        ...
        ingredients: [
            { title: 'фарш куриный', count: '400', measureUnit: 'г' },
            { title: 'яйцо', count: '1', measureUnit: 'шт.' },
            { title: 'панировочные сухари', count: '50', measureUnit: 'г' },
            { title: 'спагетти', count: '300', measureUnit: 'г' },
            { title: 'томатный соус', count: '150', measureUnit: 'мл' },
        ],
        steps: [
            {
                stepNumber: 1,
                description: 'Сформировать кнели из фарша с яйцом и сухарями.',
                image: '',
            },
            { stepNumber: 2, description: 'Отварить кнели и спагетти.', image: '' },
            { stepNumber: 3, description: 'Сервировать с соусом.', image: '' },
        ],
        meat: 'курица',
        side: 'макароны',
    },
    {
        ...
        ingredients: [
            { title: 'свинина (окорок)', count: '500', measureUnit: 'г' },
            { title: 'чеснок', count: '3', measureUnit: 'зубчика' },
            { title: 'смесь пряностей', count: '0', measureUnit: 'по вкусу' },
        ],
        steps: [
            { stepNumber: 1, description: 'Замариновать мясо в специях и чесноке.', image: '' },
            {
                stepNumber: 2,
                description: 'Обжарить до корочки, затем запечь в духовке.',
                image: '',
            },
        ],
        meat: 'свинина',
    ...
    },
    {
        ...
        description: 'Освежающий и полезный салат из свежих овощей и зелени, заряжающий энергией.',
        category: ['salads'],
        ...
        ingredients: [
            { title: 'сельдерей', count: '100', measureUnit: 'г' },
            { title: 'огурец', count: '1', measureUnit: 'шт.' },
            { title: 'оливковое масло', count: '2', measureUnit: 'ст. ложки' },
        ],
        steps: [
            { stepNumber: 1, description: 'Нарезать все овощи.', image: '' },
            { stepNumber: 2, description: 'Заправить маслом и перемешать.', image: '' },
        ],
        meat: '',
        side: '',
    },
    {
        ...
        description: 'Воздушные и румяные оладьи на кефире — идеальный завтрак выходного дня.',
        ...
        ingredients: [
            { title: 'кефир', count: '250', measureUnit: 'мл' },
            { title: 'мука', count: '200', measureUnit: 'г' },
            { title: 'яйцо', count: '1', measureUnit: 'шт.' },
            { title: 'сахар', count: '2', measureUnit: 'ст. ложки' },
        ],
        steps: [
            { stepNumber: 1, description: 'Смешать все ингредиенты до однородности.', image: '' },
            { stepNumber: 2, description: 'Жарить на сковороде до золотистой корочки.', image: '' },
        ],
        meat: '',
        side: '',
    },
    {
        ...
        description:
            'Густой суп с насыщенным вкусом и ароматом грибов — отличный выбор после праздников.',
        category: ['soups'],
        ...
        ingredients: [
            { title: 'грибы', count: '300', measureUnit: 'г' },
            { title: 'огурцы солёные', count: '2', measureUnit: 'шт.' },
            { title: 'лук', count: '1', measureUnit: 'шт.' },
            { title: 'томатная паста', count: '2', measureUnit: 'ст. ложки' },
        ],
        steps: [
            { stepNumber: 1, description: 'Обжарить грибы и лук.', image: '' },
            { stepNumber: 2, description: 'Добавить огурцы и томатную пасту.', image: '' },
            { stepNumber: 3, description: 'Залить водой и варить 40 минут.', image: '' },
        ],
        meat: '',
        side: '',
    },
